...
If you decide to try this mod, be careful, follow the instructions closely & it should work right away.

If anything goes extremely wrong, please read the [factory reset guide](https://github.com/acatone-git/Factory_Reset_RP2P) to fully recover your console.
